        ...
        try {
            ...
            if (data.success) {
                ...
                if (data.error === 'USER_NOT_FOUND') {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Username tidak ditemukan atau akun tidak aktif');
                } else if (data.error === 'INVALID_PASSWORD') {
                    setLoginError('Password salah. Silakan coba lagi.');
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Password salah. Silakan coba lagi.');
                } else {
                    setLoginError(data.message || 'Login gagal. Silakan coba lagi.');
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(data.message || 'Login gagal. Silakan coba lagi.');
                }
            }
        } catch (error) {
            console.error('Login error:', error);
            setLoginError('Terjadi kesalahan koneksi. Silakan coba lagi.');
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Terjadi kesalahan koneksi. Silakan coba lagi.');
        } finally{
            setIsLoading(false);
        }
    };
